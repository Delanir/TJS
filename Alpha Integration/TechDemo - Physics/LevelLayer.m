...
-(void)addTarget
{
    ...
    [[EnemyManager shared] addToEnemies:peasant];
    [peasant release];
...
-(void) addFairy
{
    ...
    Enemy *peasant = [[FairyDragon alloc] initWithWindowSize:winSize];
...
-(id) init
{
    if( (self=[super init]))
    {
        ...
        [self addChild:[SpriteManager addSpritesToSpriteFrameCacheWithFile:@"fairiedragon.plist" andBatchSpriteSheet:@"fairiedragon.png"  ]];
